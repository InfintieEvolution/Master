...
\usepackage{float}      % For forcing picture placement

% The following is for captions of figures
...
\newcommand{\thesisTitle}{Ledgendary Octo Sniffle: A Colourful Graph Drawing Project}
...
\mainmatter
\input{MasterThesis/chapters/chapter1-introduction.tex}
\input{MasterThesis/chapters/chapter2-Background-Theory-and-Motivation.tex}
\input{MasterThesis/chapters/chapter3-model.tex}
\input{MasterThesis/chapters/chapter4-experiments-and-results.tex}
\input{MasterThesis/chapters/chapter5-evaluation-and-conclusion.tex}
